...
const CoolBlueDesign = ({ data, onEditSection }) => {
  // --- Helper Components ---
    ...
    <div className="min-h-[11in] bg-white font-sans flex print:min-h-screen relative">
      ...
      <div className="w-1/3 bg-[#effafa] pt-12 pb-12 px-8 relative border-r border-cyan-100">
        ...
        <div className="relative mb-16 z-20 text-center">
          <EditButton section="personal" className="-top-2 -right-2" />
      ...
      <div className="w-2/3 flex flex-col relative">
        ...
        <div className="h-64 bg-[#fff0f3] flex flex-col justify-center px-12 pl-24 relative">
